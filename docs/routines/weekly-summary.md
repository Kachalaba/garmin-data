...
- **🫀 Чи були нетипові фізіологічні відхилення?** — скільки днів LOW / MODERATE / HIGH (назви конкретні дати для HIGH, якщо є). Чи є patterns — 2+ дні поспіль persistent rHR, suppressed HRV тощо. Не трактуй сигнал як діагноз.
