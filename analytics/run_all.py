...
from analytics import hrv_baseline, rhr_anomaly, risk_scores, weather_enrich, workout_segments
...
STEPS = [
    ...
    ("workout_segments", lambda: workout_segments.compute(limit_days=60, force=False)),
